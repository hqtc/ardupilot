...
const AP_Param::GroupInfo AP_CANManager::CANDriver_Params::var_info[] = {
    ...
    // @Values{Copter,Plane,Sub,Rover}: 0:Disabled,1:UAVCAN,3:ToshibaCAN,4:PiccoloCAN,5:CANTester,8:KDECAN,9:PacketDigitalCAN,11:Benewake,12:UAVR21_CAN
    // @Values: 0:Disabled,1:UAVCAN,3:ToshibaCAN,4:PiccoloCAN,5:CANTester,6:EFI_NWPMU,7:USD1,8:KDECAN,9:PacketDigital,11:Benewake,12:UAVR21_CAN
    // @User: Advanced
    // @RebootRequired: True
